...
Login to Pinata and click the `Ipload+` button selecting a file. Any file will do. Satoshi's certificate is [here]() if you want to use it. Upload your file and after the dashboard refreshes you'll see it along with a content identifier (CID).
